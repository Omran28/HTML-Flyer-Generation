...
from utils.helpers import save_image_locally, inject_images_for_preview, get_position_coordinates, parse_size, save_html
...
def image_generator_node(state: FlyerState) -> FlyerState:
    try:
        ...
        save_path = save_html(preview_html, filename="flyer_with_images.html")
